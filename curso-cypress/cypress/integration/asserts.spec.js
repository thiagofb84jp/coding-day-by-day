...
it(' Object Equality ', () => {
    ...
    expect(obj).to.be.deep.equal({ a: 1, b:2 }); //são referências distintas, caso não coloque o '.deep'
...
it(' Types ', () => {
    ...
    expect({}).to.be.an('Object'); //What the difference? (a, an) -> só por conta da grafia inglesa (artigos)?
